...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    var trigger = document.querySelectorAll(triggerSelector),
        ...
        close = document.querySelector(closeSelector); //при клике открываем модальное окно
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.style.overfloy = 'hidden'; // document.body.classList.add('modal-open');
      });
    }); //При клике на крестик закрываем модальное окно

    close.addEventListener('click', function () {
      modal.style.display = 'none';
      document.body.style.overfloy = ''; // document.body.classList.remove('modal-open');
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  var header = document.querySelector(headerSelector),
      ...
      content = document.querySelectorAll(contentSelector); //скрывать контент
  ...
  function showTabContent() {
    ...
    // по умолчанию пишем 0
    content[i].style.display = 'block'; //показываем именно нужный контент
  ...
  header.addEventListener('click', function (e) {
    ...
    target.classList.contains(tabSelector.replace(/\./, "")) || target.parentNode.classList.contains(tabSelector.replace(/\./, "")))) {
      //так как тут нужно писать без точки? то прописываем регулярное вырадение где удаляем точку
      tab.forEach(function (item, i) {
        //даем i тот индекс, по кторому кликнули
